...
<?php $form = Loader::helper('form'); ?>
	...
	<form method="get" class="form-horizontal" id="ccm-<?php echo $searchInstance?>-advanced-search" action="<?=Loader::helper('concrete/urls')->getToolsURL('files/search_results', 'seo_files')?>">
